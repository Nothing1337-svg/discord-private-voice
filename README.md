...
Не-ephemeral служебные сообщения, отправленные через общий helper временных сообщений, удаляются автоматически: успешные и информационные примерно через 5 секунд, ошибки примерно через 9 секунд. Основная панель управления не удаляется автоматически.
